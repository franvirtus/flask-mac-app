...
# SOLO per Morelli: inseriamo testo informativa e dichiarazioni
    if specialist["nome"] == "Dott.ssa Chiara Morelli":
        ...
        pdf.ln(5)
        pdf.multi_cell(0, 8, "AUTORIZZO / NON AUTORIZZO la Dott.ssa Chiara Morelli ad inviarmi materiale informativo tramite email.")
        pdf.multi_cell(0, 8, "AUTORIZZO / NON AUTORIZZO la Dott.ssa Chiara Morelli all'invio di SMS relativi agli appuntamenti.")
        pdf.ln(5)
