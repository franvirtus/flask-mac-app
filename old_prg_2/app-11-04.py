...
""",
    "3":""" <h2 style="text-align:center;">Modulo Informativa Privacy - Dott.ssa Scattolini</h2>
...
""",
    ...
    "4": """
Gentilissimo/a,<p>
    con il presente documento, io sottoscritta Dott.ssa SARA SERIOLI, e-mail sara.serioli@gmail.com, presso la sede di Virtus Gruop in qualità di Titolare del trattamento dei dati, le fornisco di seguito
le informazioni relative al trattamento dei dati personali.<p>
Categorie di dati trattati.<p>
Nell’esecuzione dell’incarico professionale conferitomi, saranno trattati con riferimento al paziente, i dati anagrafici
(nome, cognome, codice fiscale), i dati di contatto (indirizzo di residenza, numero di telefono), i dati sanitari e clinici
(diagnosi mediche, anamnesi familiare, esiti esami audiometrici etc.) e i dati contenuti in video e audio registrati
durante le sedute di terapia. Inoltre, saranno trattati anche i suoi dati anagrafici (nome, cognome, codice fiscale) e dati
di contatto (indirizzo di residenza, numero di telefono).
La raccolta di tali dati è necessaria per l’adempimento delle prestazioni professionali.<p>
Finalità del trattamento e base giuridica.<p>
I dati raccolti saranno trattati, in forza dell’incarico conferitomi, per l’esecuzione delle prestazioni professionali
richieste (es. prevenzione, diagnosi, cura, riabilitazione o per altre prestazioni da voi richieste) e, in ragione del suo
consenso espresso, per la comunicazione di eventi di informazione scientifica di interesse per il paziente e per finalità di
ricerca scientifica (redazione di articoli per riviste specializzate, relazioni a convegni).
Quest’ultima finalità sarà eseguita, anche nel rispetto dei miei obblighi professionali di segretezza, con modalità (es.
tecnica di pseudonimizzazione) tali da impedire la riconducibilità dei dati al paziente.
<p>Destinatari dei dati.<p>
I dati sanitari del paziente potranno essere comunicati, previo suo consenso espresso che potrà essere revocato in
qualsiasi momento, a medici o ad altri professionisti sanitari qualora ciò si renda necessario per l’interesse del paziente
e per i trattamenti medici che segue (es. il suo medico curante).
Inoltre, i suoi dati e i dati non sanitari del paziente potranno essere comunicati, senza necessità di consenso, anche a
soggetti terzi per l’adempimento di specifici obblighi di legge (es. Commercialista), per lo svolgimento della mia attività
(es. società hosting del server di posta elettronica o società che fornisce i servizi in cloud) e per la tutela dei miei diritti
(es. Avvocati e Assicurazioni).
<p>Trasferimento dei dati.*<p>
I dati, qualora trattati mediante strumenti telematici (es. e-mail, servizi in cloud), potranno essere conservati in Paesi
non appartenenti all’Unione Europea (ad esempio, nel caso di utilizzo di servizio di conservazione in cloud erogato
attraverso server posti fuori dall’Unione Europea) per i quali tuttavia sussiste una decisione della Commissione europea di adeguatezza della normativa di tutela del trattamento dei dati personali.(*n.b.: la sussistenza della decisione di adeguatezza da parte della Commissione Europea deve essere verificata caso per
caso da ciascun professionista e dipende dal tipo di servizio digitale che viene utilizzato ed, in particolare, dal luogo in
cui sono situati i server su cui funziona tale servizio).
<p>Durata del trattamento.<p>
Tutti i dati raccolti saranno trattati per l’intera durata del rapporto professionale per la finalità di esecuzione
dell’incarico conferitomi. Successivamente, i dati del paziente saranno trattati per ulteriori dieci anni per finalità di
ricerca scientifica e comunque per il tempo necessario per l’adempimento di specifici obblighi di legge e per l’eventuale
tutela dei miei diritti.
<p>Diritti dell’interessato.<p>
In qualsiasi momento, mediante comunicazione da inviare ai recapiti sopra indicati ed in presenza dei presupposti di
legge, potrà essere richiesto l’accesso, la cancellazione, l’aggiornamento, la rettificazione, la limitazione e l’integrazione
dei dati personali raccolti o di opporsi al trattamento di essi. Potrà inoltre ricevere in un formato strutturato, di uso
comune e leggibile da dispositivo automatico, i dati personali e potrà essere proposto reclamo all’Autorità di controllo
della protezione dei dati competenti nel caso in cui ritenga che i Suoi diritti siano stati violati.
<p>Revoca del consenso.<p>
In aggiunta ai diritti sopra elencati, potrà in qualsiasi momento revocare il consenso per quei trattamenti fondati su
di esso. In tal caso, i trattamenti effettuati precedentemente saranno comunque leciti.""",
    "5" : """
<p><strong>Informativa relativa al trattamento dei dati personali</strong><br>
ai sensi dell'art. 13 Regolamento (UE) 2016/679 (GDPR)</p>

<p>Gentile Signora / Egregio Signore,<br>
Luca Taesi (C.F. TSALCU91A11B157M, P.IVA: 03988720987, PEC: lucataesi@pec.it), in qualità di titolare del trattamento dei dati personali ("Titolare"), fornisce le seguenti informazioni ai sensi dell'art. 13 del GDPR.</p>

<p><strong>1. Dati personali oggetto del trattamento</strong><br>
Saranno trattati Dati Comuni (es. nome, cognome, telefono, email) e Dati Particolari (es. salute, dati biometrici) secondo quanto previsto dall'art. 9 del GDPR.</p>

<p><strong>2. Finalità e base giuridica del trattamento</strong><br>
Il trattamento avverrà per le seguenti finalità:
<ul>
a) tutela della salute, prevenzione, diagnosi, cura, riabilitazione, assistenza;<br>
b) attività amministrative connesse alle prestazioni;<br>
c) igiene e sicurezza nei luoghi di lavoro;<br>
d) gestione e valutazione delle sedute chinesiologiche;<br>
e) obblighi di legge;<br>
f) difesa in giudizio;<br>
g) ricerca scientifica e ricontatto del paziente per finalità affini;<br>
h) comunicazione dello stato di salute a familiari/terzi;<br>
i) comunicazione della presenza presso lo Studio;<br>
j) comunicazione a compagnie assicurative.<br>
</ul>
Per h), i), j) è richiesto consenso esplicito.</p>

<p><strong>3. Natura del conferimento e conseguenze del rifiuto</strong><br>
Il conferimento è obbligatorio per accedere alle prestazioni; il mancato conferimento ne impedisce l’erogazione.</p>

<p><strong>4. Modalità del trattamento</strong><br>
Il trattamento sarà eseguito tramite strumenti informatici/manuali, garantendo riservatezza e sicurezza nel rispetto del GDPR e del Codice Privacy. Solo soggetti autorizzati vi avranno accesso.</p>

<p><strong>5. Conservazione dei dati</strong><br>
I dati saranno conservati per il tempo necessario alle finalità indicate. Potranno essere comunicati a soggetti pubblici o privati per l'espletamento dell'incarico.</p>

<p><strong>6. Comunicazione dei dati</strong><br>
I dati potranno essere comunicati a:
<ul>
<li>enti sanitari pubblici e privati;</li>
<li>autorità pubbliche, giudiziarie, organismi sanitari;</li>
<li>laboratori, consulenti, collaboratori, familiari, medici, fisioterapisti;</li>
<li>società fornitrici di servizi IT;</li>
<li>società collegate per fini contabili o organizzativi.</li>
</ul>
Non è previsto il trasferimento a paesi terzi. Se necessario, avverrà secondo quanto stabilito dal GDPR.</p>

<p><strong>7. Conferimento dei dati</strong><br>
Necessario per le attività indicate al punto 2.</p>

<p><strong>8. Rifiuto del conferimento</strong><br>
Il rifiuto comporta l'impossibilità di adempiere alle attività.</p>

<p><strong>9. Diritti dell’interessato</strong><br>
L'interessato ha diritto di accesso, rettifica, cancellazione, limitazione, opposizione, portabilità dei dati, revoca del consenso e reclamo all'Autorità Garante.</p>

<p><em>Acquisite le summenzionate informazioni, presto il mio consenso per il trattamento dei dati, anche sanitari, necessari allo svolgimento delle operazioni indicate nell'informativa.</em></p>
...
<body>
  ...
  <strong>
    ...
    Via Corfù 71 e via Montello 79 – Brescia<br>
    Tel. 0304096895 e 3518899843<br>
    Email: virtusgroup2023@gmail.com
  </div>
  <h1>Seleziona il tuo Specialista</h1>
  ...
  <button onclick="window.location.href='/privacy/4'">Dott.ssa Serioli</button>
  <button onclick="window.location.href='/privacy/5'">Dott. Taesi</button>
</body>
</html>
'''
...
<head>
  <meta charset="utf-8">
  <title>Modulo Informativa Privacy - {{ specialist_name }}</title>
  <style>
...
<body>
  <h1>Modulo Informativa Privacy- {{ specialist_name }}</h1>
  <div class="content">
    <p>{{ privacy_text | safe}}</p>
{% if specialist == '2' %}
<form method="get" action="/form">
<input type="hidden" name="specialist" value="2">
    <strong>Dichiaro inoltre di:<p>
        <label><input type="radio" name="consenso1" value="acconsento" required>Prestare</label>
        <label><input type="radio" name="consenso1" value="Non acconsento"> Non Prestare</label><br>
        il mio consenso per le finalità di cui al punto 2, lett. C) </label><br>
        <label><input type="radio" name="consenso2" value="acconsento" required> Prestare il mio consenso per le finalità di cui al punto 2, lett. D) </label><br>
        <label><input type="radio" name="consenso3" value="acconsento" required> Prestare il mio consenso alla comunicazione dei miei dati personali e sensibili a familiari e/o a personale medico e, più in generale, sanitario</label><br>
    {% elif specialist == '3' %}
    <form method="get" action="/form">
   ...
   <!-- BLOCCO FIRMA SERIOLI -->
    {% elif specialist == '4' %}
<form method="post" action="/submit_serioli">
 
    <div style="text-align: justify; font-family: Georgia; font-size: 16px; max-width: 800px; margin: 0 auto;">
  <h2>Consensi</h2>
  <p><em>Io sottoscritto</em> (nome e cognome): <input type="text" name="nome_cognome" required></p>
  <p><em>in qualità di esercente la responsabilità genitoriale / di tutore del paziente:</em> <input type="text" name="tutore_paziente" required></p>

  <p>vista l’informativa sul trattamento dei dati personali, sopra riportata:</p>

  <p>
    <label><input type="radio" name="consenso1_serioli" value="Acconsento" required> Acconsento</label>
    <label><input type="radio" name="consenso1_serioli" value="Non acconsento"> Non acconsento</label><br>
    <em>al trattamento dei dati sanitari e dei dati contenuti nelle registrazioni video ed audio effettuate durante la terapia per finalità di ricerca scientifica</em>
  </p>

  <p>
    <label><input type="radio" name="consenso2_serioli" value="Acconsento" required> Acconsento</label>
    <label><input type="radio" name="consenso2_serioli" value="Non acconsento"> Non acconsento</label><br>
    <em>al trattamento dei dati per ricevere comunicazioni di eventi informativi connessi alla situazione sanitaria</em>
  </p>

  <p>
    <label><input type="radio" name="consenso3_serioli" value="Autorizzo" required> Autorizzo</label>
    <label><input type="radio" name="consenso3_serioli" value="Non autorizzo"> Non autorizzo</label><br>
    <em>a comunicare i dati sanitari ad altri medici o operatori sanitari presso cui è in cura il paziente</em>
  </p>

  <p><strong>Data:</strong></p>
<div style="display: inline-block;">
  <select name="giorno_serioli" required class="date-select day">
  ...
  <select name="mese_serioli" required class="date-select month">
  ...
  <span class="date-sep">/</span>
  <select name="anno_serioli" required class="date-select year">
  ...
  <label for="signature-pad-serioli"><strong>Firma Dott.ssa Serioli:</strong></label><br>
  <div style="position: relative; border: 1px solid #000; width: 500px; height: 150px;">
    <canvas id="signature-pad-serioli" width="500" height="150"></canvas>
    <input type="hidden" id="signature_data_serioli" name="signature_data_serioli">
    <h3>Firma dell’altro genitore o secondo tutore (opzionale)</h3>
    <canvas id="signature-pad-serioli-2" width="500" height="150" style="border:1px solid #000;"></canvas>
    <input type="hidden" name="signature_data_serioli_2" id="signature_data_serioli_2">


    <button type="button" onclick="clearSignature('serioli')" 
            style="position: absolute; top: -40px; right: -15px; background: none; border: none; color: red; font-weight: bold;">✖</button>
    <button type="button" onclick="clearSignature('serioli2')" 
            style="position: absolute; top: 215px; right: -15px; background: none; border: none; color: red; font-weight: bold;">✖</button>
...
{% elif specialist == '5' %}
<form method="post" action="/submit_taesi">
<label><strong>Data:</strong></label><br>




<select name="giorno_taesi" required>
...
<select name="mese_taesi" required>
...
<select name="anno_taesi" required>
...
<br><label for="luogo_taesi"><strong>Luogo:</strong></label><br>
<input type="text" id="luogo" name="luogo_taesi" required><br><br>
  <h3>Firma dell’interessato / genitore / tutore</h3>
  <canvas id="signature-pad-taesi" width="400" height="200" style="border:1px solid #000;"></canvas>
  <input type="hidden" name="signature_data_taesi" id="signature_data_taesi">
  <button type="button" onclick="clearSignature('taesi')" style="color:red; background:none; border:none; font-size: 18px; position: relative; top: -250px; left: -10px; cursor: pointer;">✖</button>

  <h3>Seconda firma (facoltativa)</h3>
  <canvas id="signature-pad-taesi-2" width="400" height="200" style="border:1px solid #000;"></canvas>
  <input type="hidden" name="signature_data_taesi_2" id="signature_data_taesi_2">
  <button type="button" onclick="clearSignature('taesi2')" style="color:red; background:none; border:none; font-size: 18px; position: relative; top: -250px; left: -10px; cursor: pointer;">✖</button>
...
{% if specialist != '4' and specialist != '5' %}
...
document.addEventListener("DOMContentLoaded", function () {
  // === SERIOLI ===
  const padSerioli1 = document.getElementById("signature-pad-serioli") ? new SignaturePad(document.getElementById("signature-pad-serioli")) : null;
  const inputSerioli1 = document.getElementById("signature_data_serioli");

  const padSerioli2 = document.getElementById("signature-pad-serioli-2") ? new SignaturePad(document.getElementById("signature-pad-serioli-2")) : null;
  const inputSerioli2 = document.getElementById("signature_data_serioli_2");

  const formSerioli = document.querySelector('form[action="/submit_serioli"]');

  if (formSerioli) {
    formSerioli.addEventListener("submit", function(e) {
      if (!padSerioli1 || padSerioli1.isEmpty()) {
        e.preventDefault();
        alert("Per favore firma nel primo riquadro (Serioli).");
        return;
      }
      inputSerioli1.value = padSerioli1.toDataURL();
      if (padSerioli2 && !padSerioli2.isEmpty()) {
        inputSerioli2.value = padSerioli2.toDataURL();
      }
    });
  }

  // === TAESI ===
  const padTaesi1 = document.getElementById("signature-pad-taesi") ? new SignaturePad(document.getElementById("signature-pad-taesi")) : null;
  const inputTaesi1 = document.getElementById("signature_data_taesi");

  const padTaesi2 = document.getElementById("signature-pad-taesi-2") ? new SignaturePad(document.getElementById("signature-pad-taesi-2")) : null;
  const inputTaesi2 = document.getElementById("signature_data_taesi_2");

  const formTaesi = document.querySelector('form[action="/submit_taesi"]');

  if (formTaesi) {
    formTaesi.addEventListener("submit", function(e) {
      if (!padTaesi1 || padTaesi1.isEmpty()) {
        e.preventDefault();
        alert("Per favore firma nel primo riquadro (Taesi).");
        return;
      }
      inputTaesi1.value = padTaesi1.toDataURL();
      if (padTaesi2 && !padTaesi2.isEmpty()) {
        inputTaesi2.value = padTaesi2.toDataURL();
      }
    });
  }

  // === UNICA FUNZIONE PER CANCELLARE TUTTE LE FIRME ===
  window.clearSignature = function(tipo) {
    if (tipo === "serioli" && padSerioli1) padSerioli1.clear();
    if (tipo === "serioli2" && padSerioli2) padSerioli2.clear();
    if (tipo === "taesi" && padTaesi1) padTaesi1.clear();
    if (tipo === "taesi2" && padTaesi2) padTaesi2.clear();
  };
});
</script>
...
<div>
  ...
  <div style="display: block; width: 100%; height: 1px;"></div>
    ...
    <button type="button" class="clear-btn" onclick="clearSignature('scattolini')" title="Cancella firma">✖</button>
  </div>
...
{% endif %}
  ...
  <div style="text-align: justify; line-height:1.6; font-family: Arial; font-size: 14px;">
    <h2 style="text-align:center;">Modulo Informativa Privacy - Dott.ssa Scattolini</h2>
    <p style="text-align:center;">C.F. SCTLND93R62B157Y - P.I. 04025560980</p>
  ...
  <button type="button" class="clear-btn" onclick="clearSignature(1)">✖</button>
...
<form method="post" action="/submit_serioli">
  ...
  <p><strong>Consensi:</strong></p>

  <label><input type="radio" name="consenso1" value="Acconsento" required> Acconsento</label>
  <label><input type="radio" name="consenso1" value="Non acconsento"> Non acconsento</label><br><br>

  <label><input type="radio" name="consenso2" value="Acconsento" required> Acconsento</label>
  <label><input type="radio" name="consenso2" value="Non acconsento"> Non acconsento</label><br><br>

  <label><input type="radio" name="consenso3" value="Autorizzo" required> Autorizzo</label>
  <label><input type="radio" name="consenso3" value="Non autorizzo"> Non autorizzo</label><br><br>

  <label for="data_firma">Data:</label>
  <input type="date" id="data_firma" name="data_firma" value="{{ current_date }}" required><br><br>

  <label>Firma:</label>
  <div class="canvas-container">
    <canvas id="signature-pad-serioli" width="400" height="150"></canvas>
    <button type="button" class="clear-btn" onclick="clearSignature('serioli')">✖</button>
  </div>
  <input type="hidden" id="signature_data_serioli" name="signature_data">
...
{% endif %}
    ...
    <form action="/submit" method="post">
        ...
        <div class="canvas-container">
          ...
          <button type="button" class="clear-btn" onclick="clearSignature('generale')" title="Cancella firma">
          X
          </button>
        </div>
        <input type="hidden" id="signature_data" name="signature_data">
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const formGenerale = document.querySelector('form[action="/submit"]');
  if (formGenerale && padGenerale) {
    formGenerale.addEventListener("submit", function(e) {
  ...
  // === UNICA FUNZIONE DI CANCELLAZIONE ===
  window.clearSignature = function(tipo) {
    if (tipo === 'generale' && padGenerale) padGenerale.clear();
    if (tipo === 'serioli' && padSerioli1) padSerioli1.clear();
    if (tipo === 'serioli2' && padSerioli2) padSerioli2.clear();
    if (tipo === 'taesi' && padTaesi1) padTaesi1.clear();
    if (tipo === 'taesi2' && padTaesi2) padTaesi2.clear();
...
def submit_scattolini():
    ...
    firma_ruolo = request.form.get("firma_ruolo", "").strip()
    ...
    <p><strong>Il sottoscritto in qualità di:</strong> {ruolo}</p>
    <h3>Firma presa visione</h3>
    {firma_1_html}
    <p><strong></strong> {autorizzazione}</p>
    <p>la dott.ssa Linda Scattolini a fornire informazioni riguardanti il proprio stato di salute a:<p>
    <p><strong>Medico di Medicina Generale dott./dott.ssa:</strong> {mmg}</p>
    <p><strong>Medico specialista dott. /dott.ssa</strong> {specialista_ref}</p>
    <p><strong>Al/alla  sig./sig.ra</strong> {persona}</p>
    <hr>

    <p><strong>Il sottoscritto in qualità di:</strong> {firma_ruolo}</p>
    <h3>Firma</h3>
    {firma_2_html}
    <h3>Acquisizione verbale del consenso per impossibilità fisica alla firma     </h3>
    {firma_3_html}
...
<head>
  <meta charset="utf-8">
  <title>Modulo Informativa Privacy- Dott.ssa Scattolini</title>
  <style>
...
<h2>Modulo Informativa Privacy - Dott.ssa Scattolini</h2>
<p style="text-align:center;"><strong>C.F. SCTLND93R62B157Y - P.I. 04025560980</strong></p>
...
<div style="margin-bottom: 30px;">
<div style="margin-bottom: 30px; display: flex; flex-direction: column; align-items: left;">
<label for="signature-pad-1" style="font-weight: bold; text-align: left; width: 500px;">Firma</label>
    <div style="position: relative; border: 1px solid #000; width: 500px; height: 150px;">
...
<div style="margin-bottom: 30px;">
  <label><strong>Acquisizione verbale del consenso per impossibilità fisica alla firma </strong></label>
  <div style="position: relative; border: 1px solid #000; width: 500px; height: 150px;">
...
<head>
    <meta charset="utf-8">
    <title>Informativa Privacy - Dott.ssa Serioli</title>
    <style>
        body { font-family: Arial, sans-serif; padding: 30px; line-height: 1.6; }
        .firma-box { border: 1px solid #000; width: 400px; height: 120px; margin-bottom: 20px; position: relative; }
        .clear-btn {
            position: absolute;
            top: 5px;
            right: 5px;
...
<p>
Io sottoscritto (nome e cognome): <input type="text" name="nome_cognome" required><br><br>
in qualità di esercente la responsabilità genitoriale / di tutore del paziente: <input type="text" name="tutore" required><br><br>
</p>

<p>Vista l’informativa sul trattamento dei dati personali, sopra riportata:</p>

<label><input type="radio" name="consenso1" value="Acconsento" required> Acconsento</label>
<label><input type="radio" name="consenso1" value="Non acconsento"> Non acconsento</label>
<p>al trattamento dei dati sanitari e dei dati contenuti nelle registrazioni video ed audio...</p>

<label><input type="radio" name="consenso2" value="Acconsento" required> Acconsento</label>
<label><input type="radio" name="consenso2" value="Non acconsento"> Non acconsento</label>
<p>al trattamento dei dati per ricevere eventuali comunicazioni di eventi di informazione scientifica...</p>

<label><input type="radio" name="consenso3" value="Autorizzo" required> Autorizzo</label>
<label><input type="radio" name="consenso3" value="Non autorizzo"> Non autorizzo</label>
<p>il Titolare del trattamento a comunicare i dati sanitari del Paziente ad altri medici...</p>

<p><strong>Data:</strong> <input type="text" name="data" value="{{ data_compilazione }}"></p>

<p><strong>Firma:</strong></p>
<div class="firma-box">
    <canvas id="firmaCanvas" width="400" height="120"></canvas>
    <button type="button" class="clear-btn" onclick="clearCanvas()">✖</button>
</div>
...
def submit():
    ...
    if specialist == "2":
        consensi_extra = f"""
        <h3>Dichiaro inoltre di:</h3>
        <ul>
            <li>Prestare il mio consenso per le finalità di cui al punto 2, lett. C)  <strong>{consenso1}</strong></li>
            <li>Prestare il mio consenso per le finalità di cui al punto 2, lett. D) {consenso2}</strong></li>
            <li>Prestare il mio consenso alla comunicazione dei miei dati personali e sensibili a familiari e/o a personale medico e, più in generale, sanitario <strong>{consenso3}</strong></li>
        </ul>
        """
...
def submit_serioli():
    ...
    tutore = request.form.get("tutore_paziente", "").strip()
    consenso1 = request.form.get("consenso1_serioli", "Non indicato")
    consenso2 = request.form.get("consenso2_serioli", "Non indicato")
    consenso3 = request.form.get("consenso3_serioli", "Non indicato")
    firma1_data = request.form.get("signature_data_serioli", "")
    firma2_data = request.form.get("signature_data_serioli_2", "")

    firma1_img_tag = f'<img src="{firma1_data}" style="width:200px;">' if firma1_data.startswith("data:image/png;base64,") else "<em>Firma mancante</em>"
    firma2_img_tag = f'<img src="{firma2_data}" style="width:200px;">' if firma2_data.startswith("data:image/png;base64,") else "<em>Firma non presente</em>"


    if not firma1_data or not firma1_data.startswith("data:image/png;base64,"):
        return "<h1>Errore: firma mancante o non valida</h1>"

    giorno = request.form.get("giorno_serioli", "")
    mese = request.form.get("mese_serioli", "")
    anno = request.form.get("anno_serioli", "")
    data_serioli = f"{giorno}/{mese}/{anno}"

    specialist = "4"
    folder_name = specialist_names.get(specialist, "Dott.ssa Sara Serioli")
    specialist_folder = os.path.join(SHARED_FOLDER, folder_name)
    os.makedirs(specialist_folder, exist_ok=True)

    timestamp_str = datetime.datetime.now().strftime('%Y%m%d_%H%M%S')
    filename_pdf = f"serioli_consenso_{timestamp_str}.pdf"
    pdf_path = os.path.join(specialist_folder, filename_pdf)

    informativa = privacy_texts.get(specialist, "[Testo dell'informativa mancante]")
    firma1_img_tag = f'<img src="{firma1_data}" style="width:200px;">'
    firma2_img_tag = f'<img src="{firma2_data}" style="width:200px;">' if firma2_data.startswith("data:image/png;base64,") else "<em>Firma non presente</em>"
    ...
    <head>
      <meta charset="utf-8">
      <title>Modulo Informativa Privacy Dott.ssa Sara Serioli</title>
    </head>
    <body style="font-family: Arial, sans-serif; line-height: 1.6; padding: 20px;">
      <h1 style="text-align:center;">Modulo Informativa Privacy - Dott.ssa Sara Serioli</h1>
      <hr>
      <p>{informativa}</p>
      <hr>

      Io sottoscritto: <strong>{nome_cognome}</strong> in qualità di esercente la responsabilità genitoriale / di tutore del paziente <strong>{tutore}</strong>, vista l’informativa sul trattamento dei dati personali, sopra
      riportata:
      <p><strong>{consenso1}</strong> al trattamento dei dati sanitari e dei dati contenuti nelle registrazioni video ed
      audio relativi al paziente effettuate durante la terapia per finalità di ricerca scientifica attraverso la divulgazione di
      essi con mezzi adeguati che garantiscano la non riconducibilità di tali dati al paziente.</p>
      <p><strong>{consenso2}</strong> al trattamento dei dati per ricevere eventuali comunicazioni di eventi di
      informazione scientifica connessi alla situazione sanitaria del paziente che possano risultare di mio interesse</strong>.
      <p><strong>{consenso3}</strong> il Titolare del trattamento a comunicare i dati sanitari del Paziente ad altri medici o
      altri operatori sanitari presso cui è in cura il paziente (es. il proprio medico curante) qualora ciò sia strettamente
      necessario al suo interesse e alla corretta esecuzione dell’incarico professionale conferito a tali professionisti.</strong></p>
      <hr>
      <p><strong>Firma del tutore:</strong><br>{firma1_img_tag}</p>
      <p><strong>Seconda firma (se presente):</strong><br>{firma2_img_tag}</p>
      <p>Data compilazione: {data_serioli}</p>
    </body>
    </html>
    """
...
@app.route("/submit_taesi", methods=["POST"])
def submit_taesi():
    nome_cognome = request.form.get("nome_cognome", "").strip()
    luogo = request.form.get("luogo_taesi", "").strip()
    giorno = request.form.get("giorno_taesi", "").strip()
    mese = request.form.get("mese_taesi", "").strip()
    anno = request.form.get("anno_taesi", "").strip()
    data = f"{giorno}/{mese}/{anno}"

    firma1 = request.form.get("signature_data_taesi", "")
    firma2 = request.form.get("signature_data_taesi_2", "")

    if not firma1 or not firma1.startswith("data:image/png;base64,"):
        return "<h1>Errore: la prima firma è obbligatoria.</h1>"

    specialist = "5"
    folder_name = specialist_names.get(specialist, "Dott. Taesi")
    specialist_folder = os.path.join(SHARED_FOLDER, folder_name)
    os.makedirs(specialist_folder, exist_ok=True)

    timestamp_str = datetime.datetime.now().strftime('%Y%m%d_%H%M%S')
    filename_pdf = f"taesi_consenso_{timestamp_str}.pdf"
    pdf_path = os.path.join(specialist_folder, filename_pdf)

    firma1_img = f'<img src="{firma1}" style="width:200px;">'
    firma2_img = f'<img src="{firma2}" style="width:200px;">' if firma2 and firma2.startswith("data:image/png;base64,") else "<p>(Firma non presente)</p>"

    informativa = privacy_texts.get(specialist, "[Informativa mancante]")

    html = f"""
    <html><body style="font-family: Arial;">
    <meta charset="utf-8">
    <h2>Modulo Privacy - Dott. Luca Taesi</h2>
    <div>{informativa}</div>
    <hr>
