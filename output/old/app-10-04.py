...
<body>
  ...
  <button onclick="window.location.href='/privacy/5'">Dott. Gialli</button>
</body>
</html>
'''
...
def submit_serioli():
    ...
    <body style="font-family: Arial, sans-serif; line-height: 1.6; padding: 20px;">
      ...
      Io sottoscritto: <strong>{nome_cognome}<strong> in qualità di esercente la
      responsabilità genitoriale / di tutore del paziente {tutore}, vista l’informativa sul trattamento dei dati personali, sopra
      riportata:
      ...
      informazione scientifica connessi alla situazione sanitaria del paziente che possano risultare di mio interesse.
      ...
      necessario al suo interesse e alla corretta esecuzione dell’incarico professionale conferito a tali professionisti.</p>
      <hr>
      <h2>Firma</h2>
      <h2>Firme</h2>
