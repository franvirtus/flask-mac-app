...
<form method="post" action="/submit_serioli">
  ...
  <div style="position: relative; border: 1px solid #000; width: 500px; height: 150px;">
    ...
    <button type="button" onclick="clearSignature('serioli')">INVIA</button>
...
<script>
  ...
  document.querySelectorAll('form').forEach(function(form) {
    ...
    document.getElementById('signature_data_serioli').value = padSerioli.toDataURL();
    }
...
def submit_serioli():
    ...
    tutore = request.form.get('tutore_paziente', '').strip()  # Fixed variable name
    consenso1 = request.form.get('consenso1_serioli', 'Non indicato')  # Fixed variable name
    consenso2 = request.form.get('consenso2_serioli', 'Non indicato')  # Fixed variable name
    consenso3 = request.form.get('consenso3_serioli', 'Non indicato')  # Fixed variable name
    data_serioli = request.form.get('data_serioli', datetime.datetime.now().strftime('%d/%m/%Y'))
    firma_data = request.form.get('signature_data_serioli', '')  # FIXED HERE
