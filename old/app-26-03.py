...
def submit():
    ...
    <body>
        <div style="text-align: justify; line-height:1.6;">
            ...
            <strong>dà il consenso</strong> , dopo avere letto la superiore informativa, dà il consenso al trattamento dei dati che lo riguardano per le finalità ivi indicate.
            </p>
            <hr>
            <h2>Firma</h2>
            {firma_img_tag}
