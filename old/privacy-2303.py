...
EMAIL_PASSWORD = "Il:centro;benessere!"  # Sostituisci con la tua app password
SHARED_FOLDER = r"C:\Salvataggio privacy"
HOST = "0.0.0.0"
PORT = 5000

# ====================================
# Dati degli specialisti (hard-coded)
# ====================================
specialists_data = {
    "1": {"nome": "Dott_Rossi"},
    "2": {"nome": "Dott_Bianchi"},
...
# ====================================
# Template: Privacy per Specialista
# Questi template sono definiti direttamente nel codice.
# ====================================
privacy_template_1 = '''
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <title>Privacy - Dott. Rossi</title>
  <style>
...
<body>
  <h1>Informativa - Dott. Rossi</h1>
  <p>[Inserisci qui il testo dell'informativa per Dott. Rossi...]</p>
  <button onclick="window.location.href='/form?specialist=1'">Accetto</button>
</body>
</html>
'''
...
<head>
  <meta charset="utf-8">
  <title>Privacy - Dott. Bianchi</title>
  <style>
    body { text-align: center; font-family: Arial, sans-serif; padding: 20px; }
    button { padding: 10px 20px; font-size: 1.2em; cursor: pointer; }
  </style>
...
<body>
  <h1>Informativa - Dott. Bianchi</h1>
  <p>[Inserisci qui il testo dell'informativa per Dott. Bianchi...]</p>
  <button onclick="window.location.href='/form?specialist=2'">Accetto</button>
</body>
</html>
'''
...
<head>
  <meta charset="utf-8">
  <title>Privacy - Dott. Verdi</title>
  <style>
    body { text-align: center; font-family: Arial, sans-serif; padding: 20px; }
    button { padding: 10px 20px; font-size: 1.2em; cursor: pointer; }
  </style>
...
<body>
  <h1>Informativa - Dott. Verdi</h1>
  <p>[Inserisci qui il testo dell'informativa per Dott. Verdi...]</p>
  <button onclick="window.location.href='/form?specialist=3'">Accetto</button>
</body>
</html>
'''
...
<body>
  <h1>Informativa - Dott. Neri</h1>
  <p>[Inserisci qui il testo dell'informativa per Dott. Neri...]</p>
  <button onclick="window.location.href='/form?specialist=4'">Accetto</button>
</body>
</html>
'''
...
def privacy_specialist(specialist):
    if specialist == "1":
        return render_template_string(privacy_template_1, specialist=specialist)
    elif specialist == "2":
        return render_template_string(privacy_template_2, specialist=specialist)
    elif specialist == "3":
        return render_template_string(privacy_template_3, specialist=specialist)
    elif specialist == "4":
        return render_template_string(privacy_template_4, specialist=specialist)
    else:
...
def submit():
    ...
    # Usa il nome del dizionario per determinare il nome della cartella (es. "Dott_Rossi")
    folder_name = specialists_data.get(specialist, {}).get("nome", f"Specialista_{specialist}")
...
# ====================================
# Rotta: /send_email - invia il PDF via email
# ====================================
