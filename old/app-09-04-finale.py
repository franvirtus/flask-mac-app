...
""",
    ...
    "4": """
Gentilissimo/a,<p> 
con il presente documento, io sottoscritta Dott.ssa SARA SERIOLI, E-mail sara.serioli@gmail.com in qualità di Titolare del trattamento dei dati, le fornisco di seguito
...
ricerca scientifica (redazione di articoli per riviste 
specializzate, relazioni a convegni).
...
attraverso server posti fuori dall’Unione Europea) per i quali tuttavia sussiste una decisione della Commissione europea di adeguatezza della normativa di tutela del trattamento dei dati personali. 
(*n.b.: la sussistenza della decisione di adeguatezza da parte della Commissione Europea deve essere verificata caso per
...
<form method="post" action="/submit_serioli">
  ...
  <p><strong>Data:</strong> <input type="text" name="data_serioli" value="{{ datetime_now }}"></p>
...
<head>
    <meta charset="utf-8">
    <title>Modulo Consenso - Dott.ssa Serioli</title>
    <style>
        body { font-family: Arial, sans-serif; padding: 30px; line-height: 1.6; }
...
def submit_serioli():
    ...
    data_serioli = datetime.datetime.now().strftime("%d/%m/%Y")
    specialist = "4"
    ...
    <head>
      <meta charset="utf-8">
      <title>Consenso Dott.ssa Sara Serioli</title>
    </head>
    <body style="font-family: Arial, sans-serif; line-height: 1.6; padding: 20px;">
      <h1 style="text-align:center;">Modulo Consenso - Dott.ssa Sara Serioli</h1>
      <p><strong>Nome e cognome:</strong> {nome_cognome}</p>
      <p><strong>Tutore del paziente:</strong> {tutore}</p>
      <p><strong>Data:</strong> {data_serioli}</p>
      <hr>
      <h2>Informativa</h2>
      <p>{informativa}</p>
      <hr>
      <p><strong>Consenso 1:</strong> {consenso1}</p>
      <p><strong>Consenso 2:</strong> {consenso2}</p>
      <p><strong>Consenso 3:</strong> {consenso3}</p>
      <hr>
      <h2>Firma</h2>
      <p>{firma_img_tag}</p>
