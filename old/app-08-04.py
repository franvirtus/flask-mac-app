...
<body>
  ...
  <button onclick="window.location.href='/privacy/4'">Dott. Serioli</button>
...
<form method="get" action="/form">
    {% if specialist == '2' %}
    <strong>Dichiaro inoltre di:<p><strong>
    ...
    {% elif specialist == '4' %}
<strong>Dichiaro inoltre di:<p><strong>
        <label><input type="radio" name="consenso5" value="acconsento" required> Prestare il mio consenso per le finalità di cui al punto 2, lett. C) </label><br>
    {% endif %}
...
{% if specialist == '3' %}
<div>
  <label for="signature-pad-serioli">Firma Serioli:</label><br>
  <div class="canvas-container">
  <div style="display: block; width: 100%; height: 1px;"></div>
