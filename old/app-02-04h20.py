...
def scattolini_view():
    return render_template_string(scattolini_template)

@app.route('/privacy/<specialist>')
def privacy_view(specialist):
    if specialist == '3':
        return redirect(f'/form?specialist=3&scattolini=1')
  ...
  <div style="text-align: justify; line-height:1.6; font-family: Arial; font-size: 14px;">
    ...
    <form method="post" action="/submit_scattolini">
            ...
            <div class="signature-container">
                ...
                <button type="button" class="clear-btn" onclick="signaturePad.clear()">Cancella firma</button>
...
<head>
    ...
    <style>
        ...
        canvas { border: 1px solid #000; width: 300px; height: 100px; }
...
<body>
    <div class="container">
        ...
        <ul>
            <li><strong>Titolare del trattamento dei dati</strong>: dott.ssa Linda Scattolini, domiciliata a Palazzolo S/O, via Lancini 11 – tel. 3331852500 – email: linda.scattolini@gmail.com</li>
            <li>I dati personali sono trattati per le finalità connesse all’erogazione del servizio sanitario richiesto...</li>
            <li>Il trattamento avviene sia in forma cartacea/manuale che con strumenti elettronici.</li>
            <li>Il mancato conferimento dei dati può comportare l’impossibilità del servizio.</li>
            <li>Gli interessati hanno diritto all’accesso, rettifica, limitazione, opposizione ecc.</li>
        </ul>
...
<form method="post" action="/submit_scattolini">
  <p><strong>Per presa visione</strong></p>

  <div class="firma-data">
    <div>Data: <input type="text" name="data_visione" required></div>
    <div>Firma: <input type="text" name="firma_visione" required></div>
  </div>
  ...
  <label><input type="checkbox" name="firma1"> Paziente</label><br>
  <label><input type="checkbox" name="firma2"> ADS/tutore/esercente la responsabilità genitoriale</label><br>
  <label><input type="checkbox" name="firma3"> Persona di riferimento</label><br><br>

  <div class="firma-data">
    <div>Data: <input type="text" name="data_finale" required></div>
    <div>Firma: <input type="text" name="firma_finale" required></div>
  </div>

  <br><p><strong>Acquisizione verbale del consenso per impossibilità fisica alla firma</strong></p>
  <div class="firma-data">
    <div>Data: <input type="text" name="data_verbale"></div>
    <div>Firma: <input type="text" name="firma_verbale"></div>
  </div>

  <br><input type="submit" value="Conferma e Genera PDF">
</form>
