...
<div style="margin-bottom: 20px;">
  <label style="font-weight: bold;">Firma (usa la tavoletta o il dito):</label>
  <div style="position: relative; border: 1px solid #000; width: 500px; height: 150px; margin-bottom: 10px;">
...
<div style="margin-top: 30px;">
  <p><strong>Il sottoscritto in qualità di:</strong></p>
  <!-- ... il resto del modulo ... -->
</div>

  <label style="font-weight: bold; margin-bottom: 5px; white-space: nowrap;">
  Firma (usa la tavole? o il dito):
</label>
...
<label><input type="radio" name="firma_ruolo" value="Persona di riferimento" required> Persona di riferimento</label><br><br>
  ...
  <div class="firma-data">
    ...
    <div>Firma 2: <input type="text" name="firma_finale" required></div>
  </div>
